...
const RegisterPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Inscription - Plateforme Bilan de Compétences</title>
        <meta name="description" content="Créez un compte pour commencer votre bilan de compétences." />
      </Helmet>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-white/10 border-white/20 rounded-lg py-3 pl-12 pr-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
            <div className="relative">
